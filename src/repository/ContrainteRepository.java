...
public class ContrainteRepository implements IdRepository<Contrainte> {
    ...
    public void sauvegarder(Contrainte c) { contraintes.add(c); }
    public List<Contrainte> chargerTous() { return new ArrayList<>(contraintes); }
    ...
    public void vider() { contraintes.clear(); }
}